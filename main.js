...
mars_images_array = ["Mars_1.jpg","Mars_2.jpg", "Mars_3.jpg", "Mars_4.jpg", "Mars_5.jpg" ];
...
window.addEventListener("keydown", my_key_down); function my_key_down(e)
   ...
   { if (rover_y >= 0) { rover_y = rover_y - 10; 
    ...
    { if (rover_y <= 500) { rover_y = rover_y + 10; 
        console.log("When down arrow is pressed, x = " + rover_x + " y = " + rover_y);
         uploadBackground(); uploadRover(); } } function left() 
    { if (rover_x >= 0) { rover_x = rover_x - 10; 
        console.log("When left arrow is pressed, x = " + rover_x + " y = " + rover_y);
         uploadBackground(); uploadRover(); } } function right() 
